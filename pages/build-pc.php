        ...
        async function showComponentModal(category) {
            ...
            try {
                ...
                if (!allComponents[category]) {
                    const response = await fetch(`http://phpbe_app_service:5000/api/products?categoryCode=${encodeURIComponent(categoryConfig[category].code)}&pageIndex=0&pageSize=100`);
