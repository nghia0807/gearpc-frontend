            ...
            <div class="col-md-12">
                ...
                <p class="profile-subtitle mb-1">
                    ...
                    <span class="user-since">
                        ...
                        Member since <?php echo isset($user['createdAt']) ? date('m/d/Y', strtotime($user['createdAt'])) : ''; ?>
                    </span>
                </p>
        ...
        <div class="col-lg-3 mb-4">
            ...
            <div class="card profile-sidebar">
                ...
                <div class="list-group list-group-flush profile-nav">
                    ...
                    <a href="#" class="list-group-item list-group-item-action side-nav-item" 
                            ...
                            <?php if ($user): ?>
                                <form id="profileForm" method="POST" action="">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="profile-field">
                                                ...
                                                <div class="input-group profile-input-group">
                                                    ...
                                                    <input type="text" class="form-control profile-input" id="username" value="<?php echo htmlspecialchars($user['username'] ?? ''); ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="profile-field">
                                                ...
                                                <div class="input-group profile-input-group">
                                                    ...
                                                    <input type="text" class="form-control profile-input" id="fullName" name="fullName" value="<?php echo htmlspecialchars($user['fullName'] ?? ''); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="profile-field">
                                                ...
                                                <div class="input-group profile-input-group">
                                                    ...
                                                    <input type="email" class="form-control profile-input" id="email" name="email" value="<?php echo htmlspecialchars($user['email'] ?? ''); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="password-section">
                                        <h4 class="mb-3"><i class="bi bi-shield-lock me-2"></i>Change Password (optional)</h4>
                                        <p class="text-muted mb-4">Leave this field empty if you don't want to change your password.</p>
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="password-field">
                                                    ...
                                                    <div class="input-group password-input-group">
                                                        ...
                                                        <input type="password" class="form-control password-input" id="newPassword" name="newPassword" placeholder="Enter new password">
                                    ...
                                    <div class="text-center mt-4">
                                        <button type="submit" name="update_profile" class="btn btn-dark btn-lg save-profile-btn">
                        ...
                        <div class="card-body">
                            <div class="security-tips">
                                ...
                                <ul class="security-tips-list">
                                    <li><i class="bi bi-check-circle-fill me-2"></i>Use strong, unique passwords for different accounts.</li>
                                    <li><i class="bi bi-check-circle-fill me-2"></i>Change your password periodically (every 3-6 months).</li>
                                    <li><i class="bi bi-check-circle-fill me-2"></i>Never share your password or login details with others.</li>
                                    <li><i class="bi bi-check-circle-fill me-2"></i>Always sign out when using public computers.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
