...
// API Endpoints
$productsApiUrl = "http://phpbe_app_service:5000/api/products?pageIndex={$pageIndex}&pageSize={$pageSize}";

// Determine which brands API to use based on whether a category is selected
if ($categoryCode) {
    $brandsApiUrl = "http://phpbe_app_service:5000/api/brands/by-category/{$categoryCode}";
} else {
    $brandsApiUrl = "http://phpbe_app_service:5000/api/brands/get_select";
}
...
<body>
    ...
    <script>
        ...
        function loadMoreProducts() {
            ...
            let apiUrl = `http://phpbe_app_service:5000/api/products?pageIndex=${currentPage}&pageSize=12`;
