        ...
        <div class="col-lg-3 mb-4">
            ...
            <div class="card profile-sidebar">
                ...
                <div class="list-group list-group-flush profile-nav">
                    ...
                    <a href="index.php?page=my-orders" class="list-group-item list-group-item-action side-nav-item active">
                        ...
                        <?php else: ?>
                            <div class="row">
                                <?php foreach ($orders as $order): ?>
                                    <?php
                                    // Get order properties with fallback values
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 d-flex flex-row order-items-preview">
                                                        <?php foreach ($previewItems as $item): ?>
                                                            ...
                                                            <div class="order-item-preview me-3">
                                                                ...
                                                                <p class="mb-0 small fw-bold"><?= htmlspecialchars($itemName) ?></p>
                                                                <p class="mb-0 small text-muted">Qty: <?= $itemQuantity ?></p>
                                                            </div>
                                                        <?php endforeach; ?>
                                                        
                                                        <?php if ($remainingItemsCount > 0): ?>
                                                            <div class="order-item-preview more-items d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="col-md-4 d-flex flex-column justify-content-between align-items-end">
                                                        ...
                                                        <a href="index.php?page=order-detail&id=<?= $orderId ?>" class="btn btn-outline-primary">
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <nav aria-label="Orders pagination">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item <?= ($pageIndex <= 0) ? 'disabled' : '' ?>">
                                                <a class="page-link" href="?page=my-orders&pageIndex=<?= max(0, $pageIndex - 1) ?>" aria-label="Previous">
                                            ...
                                            <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                                                <li class="page-item <?= ($i == $pageIndex) ? 'active' : '' ?>">
                                                    <a class="page-link" href="?page=my-orders&pageIndex=<?= $i ?>"><?= $i + 1 ?></a>
                                                </li>
                                            <?php endfor; ?>
                                            
                                            <!-- Next page button -->
                                            <li class="page-item <?= ($pageIndex >= $totalPages - 1) ? 'disabled' : '' ?>">
                                                <a class="page-link" href="?page=my-orders&pageIndex=<?= min($totalPages - 1, $pageIndex + 1) ?>" aria-label="Next">
                                            ...
                                            <!-- Last page button -->
                                            <li class="page-item <?= ($pageIndex >= $totalPages - 1) ? 'disabled' : '' ?>">
                                                <a class="page-link" href="?page=my-orders&pageIndex=<?= $totalPages - 1 ?>" aria-label="Last">
...
<?php foreach ($orders as $order): ?>
    <?php 
    // Get the order ID using fallback logic
    ...
    $paymentStatus = $order['paymentStatus'] ?? 'pending';
    // Get the total amount using fallback logic
    $totalAmount = $order['totalAmount'] ?? $order['total'] ?? 0;
    ...
    ?>
    <div class="modal fade" id="orderDetailModal<?= $orderId ?>" tabindex="-1" aria-labelledby="orderDetailModalLabel<?= $orderId ?>" aria-hidden="true">
